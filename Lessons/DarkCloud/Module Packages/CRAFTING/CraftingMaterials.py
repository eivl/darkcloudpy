...
# cyclone Spectrum
BUNDLE_OF_HAY = Crafting_Materials("Bundle of Hay", "Bunch of hay.", 2, CYCLONE)
FOREST_DEW = Crafting_Materials("Forest Dew", "Dew of the forest caught in a bottle.", 2, CYCLONE)

# lighting Spectrum
GOLD_BAR = Crafting_Materials("Gold Bar", "The only item with the same buying and selling price.", 2, LIGHTNING)
POISON = Crafting_Materials("Poison", "Don't drink this by accident.", 2, LIGHTNING)
HUNK_OF_COPPER = Crafting_Materials("Hunk of Copper", "Lump of pure copper.", 2, LIGHTNING)

# smash Spectrum
ROLLING_LOG = Crafting_Materials("Rolling Log", "Log cut from only the strongest tree.", 2, SMASH)

# exorcism Spectrum
UNKNOWN_BONE = Crafting_Materials("Unknown Bone", "Can't guess what creature this belonged to.", 2, EXORCISM)
FLOUR = Crafting_Materials("Flour", "Use this to bake when you get hungry.", 2, EXORCISM)

# chill Spectrum
GLASS_MATERIAL = Crafting_Materials("Glass Material", "Ingredient for glass.", 2, CHILL)

# flame Spectrum
GUNPOWDER = Crafting_Materials("Gunpowder", "Dangerous stuff if you're not careful.", 2, FLAME)
